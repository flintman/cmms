...
const colors = {
  ...
  shadows: {
    ...
    primary:
      '0px 1px 4px rgba(236, 72, 153, 0.25), 0px 3px 12px 2px rgba(236, 72, 153, 0.35)',
    warning:
      '0px 1px 4px rgba(245, 158, 11, 0.25), 0px 3px 12px 2px rgba(245, 158, 11, 0.35)',
    card: '0px 9px 16px rgba(0, 0, 0, 0.4), 0px 2px 2px rgba(0, 0, 0, 0.5)',
    cardSm:
      '0px 2px 3px rgba(0, 0, 0, 0.4), 0px 1px 1px rgba(0, 0, 0, 0.5)',
    cardLg:
      '0 5rem 14rem 0 rgb(0 0 0 / 60%), 0 0.8rem 2.3rem rgb(0 0 0 / 80%), 0 0.2rem 0.3rem rgb(0 0 0 / 70%)'
  },
  layout: {
    general: {
      bodyBg: '#0F0F0F'
    ...
    sidebar: {
      ...
      textColor: '#B0B5C3',
      dividerBg: '#262626',
      menuItemColor: '#D1D5DB',
      menuItemColorActive: themeColors.primary,
      menuItemBg: '#0F0F0F',
      menuItemBgActive: '#3B1747',
      menuItemIconColor: '#6B7280',
      menuItemIconColorActive: themeColors.primary,
      menuItemHeadingColor: '#E5E7EB'
    }
  },
  alpha: {
    white: {
...
export const PureDarkTheme = createTheme({
  ...
  palette: {
    ...
    action: {
      active: '#EC4899',
      hover: alpha('#EC4899', 0.1),
      hoverOpacity: 0.1,
      selected: alpha('#EC4899', 0.1),
      selectedOpacity: 0.1,
      disabled: '#6B7280',
      disabledBackground: '#262626',
      disabledOpacity: 0.38,
      focus: alpha('#EC4899', 0.2),
      focusOpacity: 0.05,
