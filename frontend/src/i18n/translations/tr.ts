const trJSON = {
  ...
  showing_in_stock_only: 'Yalnızca stokta olan parçalar gösteriliyor. Tümünü görmek için tıklayın.',
  showing_all_parts: 'Tüm parçalar gösteriliyor. Yalnızca stokta olanları görmek için tıklayın.',
  ...
  wo_age_description:
    'İş emri yaşı, iş emrinin (veya iş talebinin) oluşturulması ile tamamlanması arasındaki gün sayısı olarak tanımlanır.',
  rav_description:
