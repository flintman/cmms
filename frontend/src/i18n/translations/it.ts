const locale = {
  ...
  'work-orders.description.short':
    'Visualizza e gestisci tutte le tue attività',
  ...
  'work-orders.checks.2':
    'Visualizza un calendario delle attività attuali e future.',
  'work-orders.checks.3':
    'Visualizza gli incarichi di lavoro con informazioni critiche come informazioni sulle risorse, data di scadenza, priorità e altro ancora.',
  'work-orders.checks.4':
    'Visualizza i KPI critici, come il lavoro effettivamente completato, il tempo impiegato e il lavoro pianificato rispetto a quello non pianificato.',
  'work-requests.title':
    'Un sistema semplificato di richiesta di lavoro mobile',
  ...
  'work-requests.checks.2':
    'Riduci fino al 41% i tempi di comunicazione con i richiedenti (chiamate, e-mail, SMS).',
  'mobile-app.title':
    "Un'app CMMS mobile che potenzia il tuo team di manutenzione",
  'mobile-app.descriptions.0':
    "Grazie all'utilizzo della nostra app mobile Android, i nostri clienti possono beneficiare di una migliore organizzazione, comunicazione, responsabilità e produttività fino al 30% in più nell'intero team di manutenzione.",
  ...
  'mobile-app.checks.1':
    'Registra i loro ordini di lavoro in meno di 60 secondi',
  'mobile-app.checks.2':
    'Ricevi comunicazioni immediate tramite notifiche push ed e-mail.',
  'mobile-app.checks.3': 'Avvia nuovi ordini di lavoro mentre sei sul campo.',
  'mobile-app.checks.4':
    'Rispondere e registrare i problemi mentre si lavora effettivamente sul problema',
  'mobile-app.checks.5':
    'Cerca informazioni critiche sulle risorse durante la diagnosi di un problema.',
  ...
  'eam.checks.2':
    'Tieni traccia solo di ciò che desideri con campi personalizzati illimitati',
  'eam.checks.3':
    'Organizza le tue risorse in una chiara gerarchia genitore-figlio',
  'eam.checks.4':
    'Trova informazioni in modo rapido e semplice con i codici QR (codici a barre)',
  'eam.checks.5':
    'Ricevi dati sulle risorse in tempo reale grazie alla connettività dei sensori.',
  ...
  'pm.checks.1':
    'Notifiche automatiche push ed e-mail quando viene creato o è in scadenza un messaggio privato.',
  'pm.checks.2':
    'Il nostro Calendario, facile da usare, ti consente di visualizzare tutti i lavori aperti e le prossime scadenze PM.',
  'pm.checks.3': 'Trascina e rilascia per modificare la data di scadenza.',
  'pm.checks.4':
    'Una volta completata la manutenzione preventiva, il lavoro viene automaticamente registrato nel registro di manutenzione della risorsa.',
  ...
  'part.checks.1':
    'I tecnici sanno immediatamente se il componente è disponibile in magazzino tramite un ordine di lavoro. Se il componente non è disponibile, possono facilmente verificare la disponibilità in altre sedi.',
  'part.checks.2':
    "Monitoraggio automatico dell'utilizzo dei componenti. Man mano che gli ordini di lavoro o i PM utilizzano componenti, l'inventario verrà aggiornato automaticamente per riflettere i componenti utilizzati.",
  'part.checks.3':
    "Conoscere l'utilizzo delle parti. Visualizzare il registro delle parti per vedere dove e da chi viene utilizzata la parte",
  'part.checks.4':
    'Elimina le parti inutilizzate. Scopri quando una parte è diventata obsoleta.',
  'part.checks.5':
    'Report in tempo reale. Scopri quali parti vengono utilizzate, dove e quanto ti costano.',
  'part.checks.6':
    'Ottimizza i livelli di stock. Visualizza immediatamente le previsioni per un componente per vedere quanti componenti potrebbero essere utilizzati entro il prossimo anno.',
  'part.checks.7':
  ...
  invalid_email:
    "L'indirizzo email fornito deve essere un indirizzo email valido",
  ...
  include_cost_description:
    "Ciò aggiungerà il costo al costo totale speso per l'ordine di lavoro",
  ...
  include_time_description:
    "Ciò aggiungerà la durata al tempo totale impiegato sull'ordine di lavoro",
  ...
  add_time_description:
    'Compila i campi sottostanti per creare e aggiungere Tempo',
  feedback: 'Feedback',
  ...
  edit_wo_description:
    "Compila i campi sottostanti per aggiornare l'Ordine di Lavoro",
  'noRows.wo.message':
    'Gli ordini di lavoro sono attività o lavori che possono essere programmati o assegnati a qualcuno',
  ...
  no_access_wo:
    'Non hai accesso agli Ordini di Lavoro. Contatta il tuo amministratore se dovresti averne accesso.',
  cancel: 'Cancellare',
  ...
  wo_trigger_edit_failure:
    "Non è stato possibile modificare il trigger dell'ordine di lavoro",
  wo_trigger_delete_success:
    "Il trigger dell'ordine di lavoro è stato eliminato correttamente",
  wo_trigger_delete_failure:
    "Impossibile eliminare il trigger dell'ordine di lavoro",
  name: 'Nome',
  ...
  schedule_wo_description:
    'Compila i campi sottostanti per pianificare un ordine di lavoro',
  ...
  'noRows.pm.message':
    'Pianifica gli ordini di lavoro con trigger personalizzati',
  'noRows.pm.action': "Premi il pulsante '+' per creare un trigger",
  confirm_delete_pm:
    'Sei sicuro di voler eliminare questo trigger di ordine di lavoro?',
  no_access_pm:
    'Non hai accesso alla sezione Manutenzione preventiva. Contatta il tuo amministratore se dovresti averne accesso.',
  ...
  edit_request_description:
    'Compila i campi sottostanti per modificare la richiesta',
  'noRows.request.message': 'Gestisci le tue richieste di lavoro',
  'noRows.request.action':
    "Premi il pulsante '+' per creare una richiesta di lavoro",
  ...
  confirm_delete_file_asset:
    'Sei sicuro di voler rimuovere questo file da questa risorsa?',
  actions: 'Azioni',
  show: 'Spettacolo',
  model: 'Modello',
  ...
  confirm_delete_asset_downtime:
    'Sei sicuro di voler rimuovere questo periodo di inattività?',
  create_downtime_success:
    'Il tempo di inattività è stato aggiunto con successo',
  create_downtime_failure:
    'Non è stato possibile aggiungere il tempo di inattività',
  edit_downtime_success:
    'Il tempo di inattività è stato modificato con successo',
  ...
  add_asset_description:
    'Compila i campi sottostanti per creare e aggiungere una nuova risorsa',
  ...
  edit_location_description:
    'Compila i campi sottostanti per aggiornare la posizione',
  ...
  no_access_vendors_customers:
    'Non hai accesso a Fornitori e Appaltatori. Contatta il tuo amministratore se dovresti avere accesso.',
  no_access_people_team:
    'Non hai accesso a Persone e Team. Contatta il tuo amministratore se dovresti avere accesso.',
  no_access_analytics:
    'Non hai accesso ad Analytics. Contatta il tuo amministratore se dovresti averne accesso.',
  no_access_assets:
    'Non hai accesso alle risorse. Contatta il tuo amministratore se dovresti averne accesso.',
  no_access_categories:
    'Non hai accesso alle Categorie. Contatta il tuo amministratore se dovresti avere accesso.',
  no_access_files:
    "Non hai accesso ai file. Contatta l'amministratore se dovresti averne accesso.",
  no_access_inventory:
    "Non hai accesso all'inventario. Contatta il tuo amministratore se dovresti averne accesso.",
  no_access_meters:
    'Non hai accesso ai contatori. Contatta il tuo amministratore se dovresti averne accesso.',
  no_access_purchase_orders:
    'Non puoi creare un ordine di acquisto. Contatta il tuo amministratore se hai accesso.',
  no_access_requests:
    'Non hai accesso alle Richieste. Contatta il tuo amministratore se dovresti averne accesso.',
  no_access_settings:
    "Non hai accesso alle impostazioni. Contatta l'amministratore se dovresti avere accesso.",
  no_access_page: 'Non hai accesso a questa pagina',
  file: 'File',
  'noRows.location.message':
    'Le posizioni consentono di gestire in modo più efficiente risorse e lavoratori',
  ...
  add_set_description:
    'Compila i campi sottostanti per creare e aggiungere un nuovo set',
  create_set: 'Crea set',
  ...
  all_parts: 'Tutti i pezzi',
  showing_in_stock_only: 'Visualizzazione solo pezzi disponibili. Clicca per mostrare tutti.',
  showing_all_parts: 'Visualizzazione di tutti i pezzi. Clicca per mostrare solo quelli disponibili.',
  ...
  main_shop: 'Posizione principale',
  from: 'Da',
  ...
  update_part_description:
    'Compila i campi sottostanti per aggiornare la Parte',
  'noRows.part.message':
    'Le parti possono essere combinate in risorse o utilizzate singolarmente',
  ...
  edit_po_description:
    "Compila i campi sottostanti per aggiornare l'Ordine di Acquisto",
  purchase_order: "Ordinazione d'acquisto",
  'noRows.po.message': 'Gestisci i tuoi ordini di acquisto in un unico posto',
  'noRows.po.action':
    "Premere il pulsante '+' per creare un ordine di acquisto.",
  ...
  each_item_superior_zero:
    'La quantità di ogni articolo deve essere superiore a 0',
  ...
  wo_trigger_create_success:
    "Il trigger dell'ordine di lavoro è stato creato correttamente",
  wo_trigger_create_failure:
    "Non è stato possibile creare il trigger dell'ordine di lavoro",
  ...
  wo_trigger_edit_success:
    "Il trigger dell'ordine di lavoro è stato aggiornato correttamente",
  ...
  required_meter_update_frequency:
    'È richiesta la frequenza di aggiornamento del contatore',
  ...
  edit_meter_description:
    'Compila i campi sottostanti per modificare il contatore',
  ...
  'noRows.meter.message':
    'Le letture dei contatori ti danno la possibilità di monitorare le risorse e di attivare nuovi ordini di lavoro in base a condizioni definite',
  ...
  customer_description_description:
    'Descrivi in poche righe lo scopo di questo appaltatore...',
  ...
  'noRows.vendor.message':
    'I fornitori sono organizzazioni che forniscono beni o parti',
  ...
  add_20_users:
    'È possibile aggiungere 20 utenti alla volta premendo "Tab" o "Invio" dopo ogni inserimento di un indirizzo email. Eventuali indirizzi email duplicati e registrati verranno rimossi durante la registrazione degli utenti richiesti.',
  enter_email: "Inserisci l'indirizzo email",
  users_invite_success: 'Gli utenti sono stati invitati',
  users_invite_failure:
    'Gli utenti non possono essere invitati. Controlla il numero attuale dei membri del tuo abbonamento.',
  ...
  wo_complete_last_14_days:
    'Ordini di lavoro completati negli ultimi 14 giorni',
  no_wo_complete_last_14_days:
    'Non hai completato alcun ordine di lavoro nelle ultime due settimane',
  ADMIN_name: 'Amministratore',
  ADMIN_description:
    "L'amministratore ha accesso completo, inclusa la modifica, l'aggiunta e l'eliminazione di ordini di lavoro e richieste",
  LIMITED_ADMIN_name: 'Amministratore limitato',
  LIMITED_ADMIN_description:
    'Gli amministratori limitati hanno lo stesso accesso degli amministratori, ma non possono visualizzare/modificare le impostazioni o aggiungere/modificare persone e team. Non possono eliminare ordini di lavoro, posizioni di asset, contatori e ordini di acquisto, a meno che non abbiano creato trigger per appaltatori, categorie e progetti di manutenzione preventiva.',
  TECHNICIAN_name: 'Tecnico',
  TECHNICIAN_description:
    'I tecnici possono creare e chiudere ordini di lavoro, risorse e ubicazioni. Possono modificare ed eliminare solo ciò che hanno creato.',
  LIMITED_TECHNICIAN_name: 'Tecnico limitato',
  LIMITED_TECHNICIAN_description:
    'I tecnici limitati possono vedere solo gli ordini di lavoro assegnati loro',
  VIEW_ONLY_name: 'Solo visualizzazione',
  VIEW_ONLY_description:
    'Gli utenti di sola visualizzazione hanno accesso completo alla visualizzazione, ma non possono modificare nulla',
  ...
  'noRows.team.message':
    'I team ti aiutano a gestire gruppi specifici di persone.',
  ...
  upgrade_files:
    "Esegui l'aggiornamento per utilizzare i file nelle tue risorse, ordini di lavoro, posizioni ecc.",
  ...
  add_category_description:
    'Inserisci il nome per creare e aggiungere una nuova categoria',
  ...
  field_configuration_description:
    'È possibile contrassegnare i campi come facoltativi, nascosti o obbligatori',
  optional: 'Opzionale',
  required: 'Necessario',
  hidden: 'Nascosto',
  ...
  confirm_delete_role:
    'Sei sicuro di voler eliminare definitivamente questo ruolo?',
  users: 'Utenti',
  paid: 'Pagato',
  free: 'Gratuito',
  ...
  add_role_description:
    'Compila i campi sottostanti per creare e aggiungere un nuovo ruolo',
  ...
  auto_assign_wo_description:
    'Assegna automaticamente nuovi ordini di lavoro alla persona che li crea',
  auto_assign_requests: 'Assegnazione automatica delle richieste',
  auto_assign_requests_description:
    'Assegna automaticamente nuovi ordini di lavoro alla persona che approva la richiesta',
  disable_closed_wo_notification:
    'Disabilita le notifiche degli ordini di lavoro chiusi',
  disable_closed_wo_notification_description:
    'Disattiva le notifiche quando gli ordini di lavoro chiusi vengono aggiornati',
  ask_feedback_wo_closed:
    "Richiedi un feedback quando l'ordine di lavoro è chiuso",
  ask_feedback_wo_closed_description:
    'Agli utenti viene chiesto di fornire un feedback sul lavoro svolto',
  include_labor_in_total_cost: 'Includere il costo del lavoro nel costo totale',
  include_labor_in_total_cost_description:
    'Aggiungere i costi di manodopera al totale quando un utente registra il tempo e ha una tariffa oraria memorizzata',
  enable_wo_updates_requesters:
    'Abilita gli aggiornamenti degli ordini di lavoro per i richiedenti',
  ...
  assign_tasks_description:
    'Assegna attività personalizzate da compilare ai tecnici',
  ...
  cost_center: 'Analisi dei costi del ciclo di vita delle risorse',
  ...
  wo_age_description:
    "L'età dell'ordine di lavoro è definita come il numero di giorni trascorsi tra la creazione dell'ordine di lavoro (o richiesta di lavoro) e il suo completamento.",
  rav_description:
    "Il costo totale come % del RAV è uguale a (costo degli ordini di lavoro sull'asset / prezzo di acquisto) * 100. Lo standard del settore è un valore target del 3% per questa metrica",
  downtime_and_availability_description:
    "La disponibilità si riferisce alla percentuale di risorse in stato operativo dalla data di messa in servizio. I tempi di inattività totali si riferiscono al numero di eventi di inattività verificatisi durante l'intervallo di date specificato.",
  total_cost_description:
    'Il costo totale include il costo della manodopera, il costo aggiuntivo e il costo dei componenti in un ordine di lavoro',
  compliant_wo_description:
    'Gli ordini di lavoro conformi sono definiti come ordini di lavoro completati prima della data di scadenza. Il tempo di ciclo si riferisce al numero di giorni necessari per il completamento di un ordine di lavoro.',
  hours_worked_description:
    "Queste ore corrispondono agli ordini di lavoro che hanno una data di scadenza compresa nell'intervallo specificato nei filtri.",
  work_remaining_description:
    "Questo grafico mostra il numero di ordini di lavoro incompleti in scadenza nell'intervallo di date specificato nei filtri. Le ore stimate corrispondono a quei singoli ordini di lavoro.",
  ...
  company_details_description:
    'Gestisci le informazioni relative alla tua azienda',
  ...
  email_updates_requests:
    'Aggiornamenti via e-mail per gli ordini di lavoro richiesti',
  ...
  pay_only_for_roles:
    'Paga solo per gli utenti <strong>Admin</strong> , <strong>Technical</strong> e <strong>Limited Technical</strong> e usa <strong>Requester</strong> illimitato, <strong>View-Only</strong> gratuitamente',
  ...
  recover_password_description:
    "Inserisci l'email utilizzata per la registrazione per reimpostare la password.",
  ...
  'noRows.asset.message':
    'Le risorse sono risorse su cui la tua azienda può intervenire',
  ...
  workflow_delete_success:
    'Il flusso di lavoro è stato eliminato correttamente',
  workflow_delete_failure: 'Impossibile eliminare il flusso di lavoro',
  confirm_delete_workflow:
    'Sei sicuro di voler eliminare questo flusso di lavoro?',
  click_here: 'clicca qui',
  verify_email_title: 'Verifica email',
  verify_email_description:
    "Ti è stata inviata un'email di verifica. Controlla la posta indesiderata se non la trovi nella posta in arrivo.",
  ...
  remove_blank_meter_tasks:
    'Rimuovi attività con tipo misuratore senza misuratore',
  checklist_update_failure: 'La checklist non può essere modificata',
  ...
  request_upgrade: "Richiedi l'aggiornamento",
  operation_success: "L'operazione è un successo",
  CANCELLED: 'Respinto',
  uptime_hours: 'Tempo di attività (h)',
  downtime_hours: 'Tempo di inattività (h)',
  ...
  part_consumption_by_asset: 'Consumo parziale per asset',
  grouped_by_wo_category: 'Raggruppati per categoria di ordine di lavoro',
  ...
  request_pricing: 'Richiedi un preventivo per maggiori informazioni',
  Reports: 'Rapporti',
  ...
  Welcome: 'Benvenuto',
  Help: 'Aiuto',
  'Features tour': 'Tour delle caratteristiche',
  ...
  ui_configuration: "Configurazione dell'interfaccia utente",
