const plJSON = {
  ...
  showing_in_stock_only: 'Wyświetlanie tylko części na stanie. Kliknij, aby wyświetlić wszystkie.',
  showing_all_parts: 'Wyświetlanie wszystkich części. Kliknij, aby wyświetlić tylko na stanie.',
