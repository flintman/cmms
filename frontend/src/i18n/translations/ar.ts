const locale = {
  ...
  'part.checks.1':
    'يستطيع الفنيون معرفة ما إذا كانت القطعة متوفرة في المخزون فورًا من خلال أمر العمل. إذا لم تكن القطعة متوفرة، يمكنك بسهولة التحقق من توفرها في مواقع أخرى.',
  'part.checks.2':
  ...
  showing_in_stock_only: 'عرض القطع المتوفرة فقط. انقر لعرض الكل.',
  showing_all_parts: 'عرض جميع القطع. انقر لعرض المتوفرة فقط.',
  ...
  cost_center: 'تحليل تكلفة دورة حياة الأصول',
  ...
  wo_age_description:
    'يتم تعريف عمر أمر العمل على أنه عدد الأيام بين إنشاء أمر العمل (أو طلب العمل) وإكماله.',
  rav_description:
  ...
  checklist_update_failure: 'لم يكن من الممكن تعديل القائمة',
  contact_us: 'اتصل بنا',
  ...
  CANCELLED: 'مرفوض',
  uptime_hours: 'وقت التشغيل (ساعة)',
  downtime_hours: 'وقت التوقف (ساعة)',
  ...
  pareto_by_total_price: 'باريتو حسب السعر الإجمالي',
  cumulative_percent: 'النسبة المئوية التراكمية',
  part_consumption_by_asset: 'الاستهلاك الجزئي حسب الأصول',
  grouped_by_wo_category: 'مجمعة حسب فئة أمر العمل',
  resolution_rate: 'معدل الدقة',
  resolved: 'تم الحل',
  average: 'متوسط',
  ...
  add_file: 'إضافة ملف',
  try_for_free: 'جربه مجانا',
  choose_your_plan: 'اختر خطتك',
  STARTER_description:
    'الفرق التي تسعى إلى بناء صيانة وقائية فعالة وقوية من خلال رؤية حالة الآلات والقوى العاملة.',
  PROFESSIONAL_description:
    'الأقسام التي تحتاج إلى الاستفادة من الرؤى والتحليلات لتحقيق المزيد من النمو والإنتاجية في مجال الصيانة.',
  BUSINESS_description:
    'المنظمات جاهزة لالتقاط بيانات الصيانة والعمليات لإدارة مواقع متعددة وتخصيص النظام.',
