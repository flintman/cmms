const locale = {
  ...
  in_stock: 'In Stock',
  all_parts: 'All Parts',
  showing_in_stock_only: 'Showing in-stock parts only. Click to show all.',
  showing_all_parts: 'Showing all parts. Click to show in-stock only.',
