const deJSON = {
  ...
  showing_in_stock_only: 'Nur vorrätige Teile werden angezeigt. Klicken um alle anzuzeigen.',
  showing_all_parts: 'Alle Teile werden angezeigt. Klicken um nur vorrätige anzuzeigen.',
