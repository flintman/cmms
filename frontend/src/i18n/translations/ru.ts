const ruJSON = {
  ...
  showing_in_stock_only: 'Показаны только детали в наличии. Нажмите, чтобы показать все.',
  showing_all_parts: 'Показаны все детали. Нажмите, чтобы показать только в наличии.',
  ...
  'free_cmms.title':
    'Бесплатное программное обеспечение Atlas CMMS | Кредитная карта не требуется',
  ...
  'free_cmms.hero.subtitle': 'Бесплатное программное обеспечение CMMS',
  'free_cmms.hero.title':
    'Управляйте заказами на работу и активами - Бесплатно навсегда',
  ...
  'free_cmms.hero.start_free': 'Начните бесплатно сейчас',
  'free_cmms.hero.work_orders_alt': 'Заказы на работу',
  'free_cmms.hero.mobile_app_alt': 'Мобильное приложение',
  'free_cmms.features.work_orders.title': 'Заказы на работу без усилий',
  'free_cmms.features.work_orders.p1':
    'Создавайте, назначайте и отслеживайте заказы на работу за секунды.',
  'free_cmms.features.work_orders.p2':
    'Прикрепляйте фотографии, руководства и контрольные списки к любой задаче.',
  'free_cmms.features.work_orders.p3':
    'Контролируйте прогресс в режиме реального времени с мгновенными обновлениями статуса.',
  'free_cmms.features.work_orders.alt': 'Управление заказами на работу',
  'free_cmms.features.asset_tracking.title':
    'Отслеживание жизненного цикла активов',
  'free_cmms.features.asset_tracking.p1':
    'Ведите полную цифровую историю каждого актива.',
  'free_cmms.features.asset_tracking.p2':
    'Принимайте решения о ремонте или замене на основе данных.',
  'free_cmms.features.asset_tracking.p3':
    'Будьте готовы к аудитам благодаря автоматизированным журналам соответствия.',
  'free_cmms.features.asset_tracking.alt': 'Управление активами',
  'free_cmms.features.inventory.title': 'Запасы и запчасти',
  'free_cmms.features.inventory.p1':
    'Отслеживайте уровень запасов в нескольких местах в режиме реального времени.',
  'free_cmms.features.inventory.p2':
    'Сканируйте QR-коды для мгновенного поиска и использования запчастей.',
  'free_cmms.features.inventory.p3':
    'Получайте автоматические оповещения о низком уровне запасов и мгновенно делайте повторный заказ.',
  'free_cmms.features.inventory.alt': 'Управление запасами',
  'free_cmms.features.mobile.title': 'Техническое обслуживание на ходу',
  'free_cmms.features.mobile.p1':
    'Полная функциональность мобильного приложения для iOS и Android.',
  'free_cmms.features.mobile.p2':
    'Снимайте фотографии и сканируйте штрих-коды прямо на месте.',
  'free_cmms.features.mobile.p3':
    'Мгновенно синхронизируйте данные и при необходимости работайте в автономном режиме.',
  'free_cmms.features.mobile.alt': 'Мобильное приложение CMMS',
  'free_cmms.features.get_started_free': 'Начать бесплатно',
  'free_cmms.features.ready_to_optimize':
    'Готовы оптимизировать техническое обслуживание?',
  ...
  'noRows.request_portal.message': 'Похоже, у вас пока нет порталов запросов.',
  ...
  portal_link_description:
    'Только люди с этой ссылкой могут получить доступ к порталу.',
  ...
  api_key_created_success: 'API ключ успешно создан',
  api_key_code_copied: 'Код API ключа скопирован в буфер обмена',
  api_key_code_view_once:
    'Этот код можно просмотреть только один раз. Пожалуйста, скопируйте его сейчас, так как позже вы не сможете его увидеть.',
