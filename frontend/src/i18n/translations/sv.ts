const locale = {
  ...
  'work-orders.checks.1':
    'Ställ in uppgiftsprioritet så att rätt arbete blir gjort först.',
  'work-orders.checks.2':
    'Visa en kalender över aktuella och kommande uppgifter.',
  'work-orders.checks.3':
    'Visa arbetsuppgifter med viktig information som tillgångsinformation, förfallodatum, prioritet med mera.',
  'work-orders.checks.4':
    'Visa kritiska nyckeltal som faktiskt slutfört arbete, nedlagd tid och planerat kontra oplanerat arbete.',
  'work-requests.title':
    'Ett strömlinjeformat mobilt system för arbetsförfrågningar',
  ...
  'work-requests.checks.2':
    'Minska tiden det tar att kommunicera med beställare med upp till 41 % (samtal, e-post, sms).',
  'mobile-app.title': 'En mobil CMMS-app som stärker ditt underhållsteam',
  'mobile-app.descriptions.0':
    'Genom att använda vår Android-mobilapp upplever våra kunder bättre organisation, kommunikation, ansvarsskyldighet och produktivitet med upp till 30 % i hela sitt underhållsteam.',
  'mobile-app.descriptions.1':
    'Från sin handhållna enhet kan alla i ditt underhållsteam:',
  'mobile-app.checks.0':
    'Se deras tilldelade arbetsordrar och projektledningar.',
  'mobile-app.checks.1': 'Logga sina arbetsordrar på under 60 sekunder',
  'mobile-app.checks.2':
    'Få omedelbar kommunikation via push- och e-postmeddelanden.',
  'mobile-app.checks.3': 'Starta nya arbetsordrar ute i fält.',
  'mobile-app.checks.4':
    'Svara på och logga problem medan du faktiskt arbetar med problemet',
  'mobile-app.checks.5':
    'Sök efter information om viktig tillgång vid problemdiagnostik.',
  ...
  'eam.checks.3':
    'Organisera dina tillgångar i en tydlig hierarki mellan förälder och barn',
  'eam.checks.4':
    'Hitta information snabbt och enkelt med QR-koder (streckkoder)',
  ...
  'pm.checks.1':
    'Automatiska push- och e-postmeddelanden när ett PM skapas eller förfaller.',
  'pm.checks.2':
    'I vår lättanvända kalender kan du se alla lediga arbeten och kommande PM-scheman.',
  'pm.checks.3': 'Dra och släpp för att ändra förfallodatum.',
  'pm.checks.4':
    'När underhållsarbetet är klart loggas arbetet automatiskt i tillgångens underhållslogg.',
  ...
  'part.checks.1':
    'Tekniker vet direkt om delen finns i lager inifrån en arbetsorder. Om delen inte finns i lager kan du enkelt kontrollera andra platser för att se om den är tillgänglig.',
  'part.checks.2':
    'Automatisk spårning av reservdelar. När arbetsordrar eller projektledningar använder reservdelar uppdateras lagret automatiskt för att återspegla de använda reservdelarna.',
  'part.checks.3':
    'Ta reda på hur delen används. Visa delloggen för att se var delen används och av vem.',
  'part.checks.4':
    'Eliminera oanvända delar. Vet när en del har blivit gammal.',
  'part.checks.5':
    'Rapportering i realtid. Ta reda på vilka delar som används var och hur mycket de kostar dig.',
  'part.checks.6':
    'Optimera lagernivåerna. Se direkt prognoser för en del för att se hur många delar som kan komma att användas under nästa år.',
  'part.checks.7':
    'Streckkodssökning. Gör ditt lager enkelt att spåra och komma åt med anpassade QR-koder',
  ...
  include_cost_description:
    'Detta kommer att lägga till kostnaden till den totala kostnaden som spenderats på arbetsordern.',
  ...
  add_cost_description:
    'Fyll i fälten nedan för att skapa och lägga till ytterligare kostnad',
  add: 'Tillägga',
  hourly_rate: 'Timpris',
  include_time: 'Inkludera denna tid i den totala tiden',
  include_time_description:
    'Detta lägger till varaktigheten till den totala tiden som spenderats på arbetsordern.',
  ...
  wo_archive_confirm:
    'Är du säker på att du vill arkivera den här arbetsordern?',
  ...
  confirm_delete_file_wo:
    'Är du säker på att du vill ta bort den här filen från den här arbetsordern?',
  archive: 'Arkiv',
  labors: 'Arbeten',
  ...
  required_wo_title: 'Arbetsordertitel krävs',
  add_wo: 'Lägg till arbetsorder',
  add_wo_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny arbetsorder',
  edit_wo: 'Redigera arbetsorder',
  edit_wo_description: 'Fyll i fälten nedan för att uppdatera arbetsordern',
  'noRows.wo.message':
    'Arbetsordrar är uppgifter eller jobb som kan schemaläggas eller tilldelas någon',
  ...
  no_access_wo:
    'Du har inte åtkomst till arbetsordrar. Kontakta din administratör om du behöver åtkomst.',
  cancel: 'Avboka',
  select_parts: 'Välj delar',
  sets_of_parts: 'Delar i set',
  paused: 'Pausad',
  ...
  schedule_wo_description:
    'Fyll i fälten nedan för att schemalägga en arbetsuppgift',
  edit_wo_trigger: 'Redigera arbetsorderutlösare',
  edit_wo_trigger_description:
    'Fyll i fälten nedan för att redigera arbetsorderutlösaren',
  ...
  confirm_delete_pm:
    'Är du säker på att du vill ta bort den här arbetsorderutlösaren?',
  no_access_pm:
    'Du har inte åtkomst till avsnittet Förebyggande underhåll. Kontakta din administratör om du behöver åtkomst.',
  ...
  add_request_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny förfrågan',
  ...
  'noRows.request.action':
    "Tryck på knappen '+' för att skapa en arbetsförfrågan",
  ...
  confirm_delete_file_asset:
    'Är du säker på att du vill ta bort den här filen från den här tillgången?',
  actions: 'Åtgärder',
  show: 'Visa',
  model: 'Modell',
  ...
  confirm_delete_asset_downtime:
    'Är du säker på att du vill ta bort den här driftstoppstiden?',
  ...
  add_asset_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny tillgång',
  ...
  add_location_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny plats',
  ...
  add_floor_plan_description:
    'Fyll i fälten nedan för att skapa en ny planritning',
  ...
  no_access_location:
    'Du har inte åtkomst till Platser. Kontakta din administratör om du behöver åtkomst.',
  no_access_vendors_customers:
    'Du har inte åtkomst till Leverantörer och Entreprenörer. Kontakta din administratör om du behöver åtkomst.',
  no_access_people_team:
    'Du har inte åtkomst till Personer och team. Kontakta din administratör om du behöver åtkomst.',
  no_access_analytics:
    'Du har inte åtkomst till Analytics. Kontakta din administratör om du behöver åtkomst.',
  no_access_assets:
    'Du har inte åtkomst till resurser. Kontakta din administratör om du behöver åtkomst.',
  no_access_categories:
    'Du har inte åtkomst till kategorier. Kontakta din administratör om du behöver åtkomst.',
  no_access_files:
    'Du har inte åtkomst till filer. Kontakta din administratör om du behöver åtkomst.',
  no_access_inventory:
    'Du har inte åtkomst till Inventariet. Kontakta din administratör om du behöver åtkomst.',
  no_access_meters:
    'Du har inte åtkomst till mätare. Kontakta din administratör om du behöver åtkomst.',
  no_access_purchase_orders:
    'Du kan inte skapa en inköpsorder. Kontakta din administratör om du ska ha åtkomst.',
  no_access_requests:
    'Du har inte åtkomst till förfrågningar. Kontakta din administratör om du behöver åtkomst.',
  no_access_settings:
    'Du har inte åtkomst till inställningarna. Kontakta din administratör om du behöver åtkomst.',
  no_access_page: 'Du har inte åtkomst till den här sidan',
  file: 'Fil',
  'noRows.location.message':
    'Platser låter dig hantera tillgångar och arbetare mer effektivt',
  ...
  add_set_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny uppsättning',
  ...
  confirm_delete_set:
    'Är du säker på att du vill ta bort den här uppsättningen?',
  ...
  showing_in_stock_only: 'Visar endast delar i lager. Klicka för att visa alla.',
  showing_all_parts: 'Visar alla delar. Klicka för att visa endast i lager.',
  ...
  add_part_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny del',
  create_part: 'Skapa del',
  update_part: 'Uppdatera del',
  update_part_description: 'Fyll i fälten nedan för att uppdatera delen',
  'noRows.part.message':
    'Delar kan kombineras till tillgångar eller användas var för sig',
  ...
  po_details: 'Detaljer om inköpsorder',
  ...
  add_wo_trigger_description:
    'Fyll i fälten nedan för att skapa och lägga till en arbetsorderutlösare',
  ...
  add_meter_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny mätare',
  ...
  required_reading_value: 'Avläsningsvärde krävs',
  wo_triggers: 'Arbetsorderutlösare',
  add_trigger: 'Lägg till utlösare',
  meter_details: 'Mätardetaljer',
  'noRows.meter.message':
    'Mätaravläsningar ger dig möjlighet att övervaka tillgångar och utlösa nya arbetsordrar baserat på definierade villkor',
  ...
  customer_description_description:
    'Beskriv syftet med denna entreprenör med några rader...',
  ...
  add_customer_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny entreprenör',
  ...
  confirm_delete_customer:
    'Är du säker på att du vill ta bort den här entreprenören?',
  ...
  add_vendor_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny leverantör',
  confirm_delete_vendor:
    'Är du säker på att du vill ta bort den här leverantören?',
  'noRows.vendor.message':
    'Leverantörer är organisationer som tillhandahåller tillgångar eller delar',
  ...
  add_20_users:
    "Du kan lägga till 20 användare åt gången genom att trycka på 'tabb' eller 'enter' efter varje e-postadress. Alla dubbletter och registrerade e-postadresser kommer att tas bort när de begärda användarna registreras.",
  enter_email: 'Ange e-postadress',
  users_invite_success: 'Användare har blivit inbjudna',
  users_invite_failure:
    'Användare kan inte bjudas in. Kontrollera ditt nuvarande antal prenumerationsmedlemmar.',
  ...
  wo_complete_last_14_days:
    'Arbetsordrar slutförda under de senaste 14 dagarna',
  no_wo_complete_last_14_days:
    'Du har inte slutfört några arbetsordrar under de senaste två veckorna',
  ADMIN_name: 'Administratör',
  ADMIN_description:
    'Administratören har fullständig åtkomst; inklusive att redigera, lägga till och ta bort arbetsordrar och förfrågningar',
  LIMITED_ADMIN_name: 'Begränsad administratör',
  LIMITED_ADMIN_description:
    'Begränsade administratörer har samma åtkomst som administratörer, förutom att de inte kan visa/redigera inställningar eller lägga till/redigera personer och team. De kan inte ta bort arbetsordrar, tillgångsplatser, mätare och inköpsordrar om de inte har skapat entreprenörer, kategorier och projektledningsutlösare.',
  TECHNICIAN_name: 'Tekniker',
  TECHNICIAN_description:
    'Tekniker kan skapa och stänga arbetsordrar, tillgångar och platser. Kan bara redigera och ta bort det de har skapat.',
  LIMITED_TECHNICIAN_name: 'Begränsad tekniker',
  LIMITED_TECHNICIAN_description:
    'Begränsade tekniker kan bara se arbetsordrar som tilldelats dem',
  VIEW_ONLY_name: 'Endast visning',
  VIEW_ONLY_description:
    'Användare som endast kan läsa har fullständig åtkomst men kan inte redigera något',
  REQUESTER_name: 'Begärande',
  REQUESTER_description:
    'Begärande kan bara skicka in arbetsförfrågningar och se deras status',
  select_user_role: 'Välj användarroll',
  'noRows.team.message':
    'Team hjälper dig att hantera specifika grupper av människor.',
  ...
  upgrade_files:
    'Uppgradera för att använda filer i dina tillgångar, arbetsordrar, platser etc...',
  ...
  add_category_description:
    'Fyll i namnet för att skapa och lägga till en ny kategori',
  edit_category: 'Redigera kategori',
  edit_category_description: 'Fyll i namnet för att redigera kategorin',
  no_category_action:
    "Tryck på knappen '+' för att lägga till din första kategori.",
  ...
  field_configuration_description:
    'Du kan markera fält som Valfria, Dolda eller Obligatoriska',
  optional: 'Frivillig',
  required: 'Nödvändig',
  hidden: 'Dold',
  ...
  confirm_delete_role:
    'Är du säker på att du vill ta bort den här rollen permanent?',
  users: 'Användare',
  paid: 'Betald',
  free: 'Gratis',
  ...
  add_role_description:
    'Fyll i fälten nedan för att skapa och lägga till en ny roll',
  ...
  auto_assign_wo_description:
    'Tilldela automatiskt nya arbetsordrar till den person som skapar dem',
  auto_assign_requests: 'Tilldela förfrågningar automatiskt',
  auto_assign_requests_description:
    'Tilldela automatiskt nya arbetsordrar till den person som godkänner begäran',
  disable_closed_wo_notification:
    'Inaktivera aviseringar om stängda arbetsordrar',
  disable_closed_wo_notification_description:
    'Inaktivera aviseringar när stängda arbetsordrar uppdateras',
  ask_feedback_wo_closed: 'Be om feedback när arbetsordern är stängd',
  ask_feedback_wo_closed_description:
    'Användare ombeds att ge feedback på utfört arbete',
  include_labor_in_total_cost:
    'Inkludera arbetskostnaden i den totala kostnaden',
  include_labor_in_total_cost_description:
    'Lägg till arbetskostnader till totalsumman när en användare loggar tid och har en timtaxa lagrad',
  enable_wo_updates_requesters:
    'Aktivera uppdateringar av arbetsordrar för beställare',
  ...
  confirm_delete_checklist:
    'Är du säker på att du vill ta bort den här checklistan?',
  ...
  assign_tasks_description:
    'Tilldela anpassade uppgifter som tekniker ska fylla i',
  ...
  cost_center: 'Analys av tillgångens livscykelkostnad',
  ...
  completion_comparison_description:
    'Jämförelse av olika typer av slutförda arbetsordrar.',
  wo_age_description:
    'Arbetsorderns ålder definieras som antalet dagar mellan skapandet av arbetsordern (eller arbetsförfrågan) och slutförandet.',
  rav_description:
    'Total kostnad som % av RAV är lika med (kostnad för arbetsordrar på tillgång / inköpspris) * 100. Branschstandard är ett målvärde på 3 % för detta mätvärde.',
  downtime_and_availability_description:
    'Tillgänglighet avser den procentandel som tillgångarna varit i drifttillstånd sedan de togs i bruk. Totala driftstopp avser antalet driftstoppshändelser som inträffade under det angivna datumintervallet.',
  total_cost_description:
    'Totalkostnaden inkluderar arbetskostnad, extra kostnad och delkostnad i en arbetsorder.',
  compliant_wo_description:
    'Kompatibla arbetsordrar definieras som arbetsordrar som slutfördes före förfallodatumet. Cykeltid avser antalet dagar tills en arbetsordrar slutfördes.',
  hours_worked_description:
    'Dessa timmar motsvarar arbetsordrar som har ett förfallodatum inom det intervall som anges i filtren.',
  work_remaining_description:
    'Det här diagrammet visar antalet ofullständiga arbetsordrar som förfaller inom det datumintervall som anges i filtren. De uppskattade timmarna motsvarar dessa individuella arbetsordrar.',
  ...
  company_details_description:
    'Hantera information relaterad till ditt företag',
  learn_more: 'Läs mer',
  profile: 'Profil',
  ...
  pay_only_for_roles:
    'Betala endast för <strong>administratörer</strong> , <strong>tekniska användare</strong> och <strong>begränsade tekniska</strong> användare, och använd obegränsat <strong>antal förfrågningar</strong> och <strong>endast visning</strong> gratis.',
  ...
  recover_password_description:
    'Ange e-postadressen som användes för registrering för att återställa ditt lösenord.',
  ...
  check_mails_for_instructions:
    'Kontrollera din e-post för ytterligare instruktioner',
  ...
  'noRows.asset.message':
    'Tillgångar är resurser som ditt företag kan ingripa i',
  ...
  confirm_delete_workflow:
    'Är du säker på att du vill ta bort det här arbetsflödet',
  click_here: 'Klicka här',
  verify_email_title: 'Verifiera e-postadress',
  verify_email_description:
    'Ett verifieringsmejl har skickats till dig. Kolla skräpposten om du inte ser det i din inkorg.',
  upgrade: 'Uppgradera',
  ...
  remove_blank_meter_tasks: 'Ta bort uppgifter med typen mätare utan mätare',
  checklist_update_failure: 'Checklistan kunde inte redigeras',
  ...
  request_upgrade: 'Begär uppgradering',
  operation_success: 'Operationen är en succé',
  CANCELLED: 'Avvisad',
  uptime_hours: 'Drifttid (h)',
  downtime_hours: 'Stilleståndstid (h)',
  mark_all_as_seen: 'Markera alla som sett',
  estimation_accuracy_ratio: 'Uppskattningsnoggrannhetsförhållande',
  download_template: 'Ladda ner mall',
  pareto_by_total_price: 'Pareto efter totalpris',
  cumulative_percent: 'Kumulativ procentandel',
  part_consumption_by_asset: 'Delförbrukning per tillgång',
  grouped_by_wo_category: 'Grupperad efter arbetsorderkategori',
  resolution_rate: 'Upplösningsfrekvens',
  resolved: 'Löst',
  average: 'Genomsnitt',
  ...
  no_file_linked_to_wo: 'Ingen fil bifogad till denna arbetsorder',
  add_file: 'Lägg till fil',
  try_for_free: 'Prova gratis',
  choose_your_plan: 'Välj din plan',
  STARTER_description:
  ...
  book_demo: 'Boka en demo',
  request_pricing: 'Begär prisuppgifter för mer information',
  Reports: 'Rapporter',
  'Custom dashboard built using the included components':
    'Anpassad instrumentpanel byggd med de medföljande komponenterna',
  Export: 'Exportera',
  ...
  Welcome: 'Välkomna',
  Help: 'Hjälp',
  'Features tour': 'Funktionsvisning',
  'Getting started guide': 'Komma igång-guide',
  ...
  'View all notifications': 'Visa alla aviseringar',
  rate: 'hastighet',
  select_at_least_column: 'Välj minst en kolumn',
  already_read: 'Redan läst',
  OPERATIONAL: 'Operativ',
  DOWN: 'Ner',
  ...
  password_leave_empty_if_you_dont_want_to_change:
    'Lösenord - lämna tomt om du inte vill ändra det',
  ...
  'free_cmms.features.asset_tracking.title':
    'Spårning av Tillgångars Livscykel',
  ...
  portal_link_description:
    'Endast personer med denna länk kan komma åt portalen.',
  ...
  api_key_label: 'API-nyckelns etikett',
  api_key_created_success: 'API-nyckel skapad framgångsrikt',
  api_key_code_copied: 'API-nyckelkod kopierad till urklipp',
  api_key_code_view_once:
    'Den här koden kan bara visas en gång. Kopiera den nu eftersom du inte kan se den igen.',
